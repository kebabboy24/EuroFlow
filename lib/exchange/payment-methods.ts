    ...
    regions: [
      {
        ...
        name: "Украина",
        methods: [
          { id: "monobank", name: "Monobank", iconSrc: "/banks/monobank.png", iconKey: "monobank", iconScale: 1.08, popular: true },
          { id: "privatbank", name: "PrivatBank", iconSrc: "/banks/privatbank.png", iconKey: "privatbank", popular: true },
          { id: "pumb", name: "PUMB", iconSrc: "/banks/pumb.png", iconKey: "pumb", iconScale: 1.08 },
          { id: "oschadbank", name: "Oschadbank", iconSrc: "/banks/oschadbank.jpg", iconKey: "oschadbank", iconScale: 1.08 },
          { id: "raiffeisen_ua", name: "Raiffeisen Ukraine", iconSrc: "/banks/raiffeisen.png", iconKey: "raiffeisen", iconScale: 1.08 },
    ...
    regions: [
      {
        ...
        methods: [
          ...
          { id: "liberty", name: "Liberty Bank", iconSrc: "/banks/liberty-bank.png", iconKey: "liberty", iconScale: 1.08 },
          { id: "credo", name: "Credo Bank", iconSrc: "/banks/credo-bank.jpg", iconKey: "credo", iconScale: 1.08 },
          otherMethod,
        ],
      },
    ],
    ...
    regions: [
      {
        ...
        methods: [
          ...
          { id: "sepa", name: "SEPA", iconSrc: "/banks/sepa.jpg", iconKey: "sepa", iconScale: 1.08, popular: true, requiredFields: [ibanDetails] },
          { id: "revolut", name: "Revolut", iconSrc: "/banks/revolut.png", iconKey: "revolut", iconScale: 1.02, popular: true, requiredFields: [payoutDetails] },
          { id: "wise", name: "Wise", iconSrc: "/banks/wise.webp", iconKey: "wise", iconScale: 1.08, popular: true, requiredFields: [payoutDetails] },
          { id: "erste", name: "Erste Bank", iconSrc: "/banks/erste-bank.png", iconKey: "erste", iconScale: 1.08, requiredFields: [ibanDetails] },
          { id: "raiffeisen_at", name: "Raiffeisen Austria", iconSrc: "/banks/raiffeisen.png", iconKey: "raiffeisen", iconScale: 1.08, requiredFields: [ibanDetails] },
          { id: "n26", name: "N26", iconSrc: "/banks/n26.png", iconKey: "n26", iconScale: 1.02, requiredFields: [ibanDetails] },
